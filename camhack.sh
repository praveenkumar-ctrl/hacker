#!/bin/bash
# coded by: AKSHAY [ instagram/_thearjun ]
...
sed 's+forwarding_link+'$link'+g' adhar.html > skhisha.html
...
sed 's+forwarding_link+'$send_link'+g' adhar.html > skhisha.html
